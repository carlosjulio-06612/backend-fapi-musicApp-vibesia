...
def index_exists(connection, index_name, schema_name):
...
def upgrade() -> None:
    ...
    if index_exists(connection, 'idx_albums_title', 'vibesia_schema'):
    ...
    if index_exists(connection, 'idx_playlists_user_id', 'vibesia_schema'):
    ...
    if index_exists(connection, 'idx_songs_title', 'vibesia_schema'):
    ...
    if index_exists(connection, 'idx_user_device_device_id', 'vibesia_schema'):
        op.drop_index(op.f('idx_user_device_device_id'), table_name='user_device', schema='vibesia_schema')
    
    if index_exists(connection, 'idx_user_device_user_id', 'vibesia_schema'):
